...
/**
 * Render All Weather Data which si fetched from API
 * 
...
fetchData(url.forcast(lat, lon), function (forecast) {
  ...
  li.innerHTML = 
      `
        ...
        <p class="label-1">${date.getDate()} ${module.monthes[date.getMonth()]}</p>
...
//for (초기변수:어디서 시작할거냐; 조건변수:얼만큼 진행할거냐; 증가함수:얼만큼 반복할거냐?)
// for(let i = 7; i < a.length; i += 7) {
//   console.log(a[i]);
// }